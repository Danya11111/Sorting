...
Данный алгоритм является гибридным и стабильным.
Он использует в своей основе сортировку слиянием
и сортировку вставками. Алгоритм находит наборы 
данных, которые уже упорядочены, и использует 
их для более эффективной сортировки.
*/
